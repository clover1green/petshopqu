...
<div id="carouselExampleIndicators" class="carousel slide mt-5" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?= url ?>assets/images/pages/banner1.png" class="d-block w-100" alt="..." style="height:400px !important;">
        </div>
        <div class=" carousel-item">
            <img src="<?= url ?>assets/images/pages/banner2.png" class="d-block w-100" alt="..." style="height:400px !important;">
        </div>
    </div>
</div>
