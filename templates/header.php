    ...
    <nav class="navbar navbar-expand-lg shadow-sm bg-white ">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav col-6">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= url ?>tentang.php" style="font-size: 20px !important;">Tentang</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= url ?>kontak.php" style="font-size: 20px !important;">Kontak</a>
                </li>
                <li class="nav-item">
